        ...
        const fetchAnalyticsData = async () => {
            try {
                ...
                setAnalyticsData({
                    ...
                    totalSales: analyticsData?.totalSales ?? analyticsData?.sales ?? 0,
                    totalRevenue: analyticsData?.totalRevenue ?? analyticsData?.revenue ?? 0,
                });

                setDailySalesData(
                    (dailySalesData || []).map((item) => ({
                        date: item.date || item.name || item._id || "",
